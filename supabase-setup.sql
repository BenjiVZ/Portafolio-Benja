...
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('VA-Bus - Reservas de pasajes para Aerorutas','Sistema completo de reservas de pasajes para Aerorutas (Venezuela). El backend en Django REST Framework gestiona viajes, buses, rutas y distribución de asientos, reservas con selección de puesto, pagos con comprobantes y usuarios con autenticación JWT y Google OAuth; incluye un módulo de integración con APIs externas y un backoffice. El frontend es una SPA en React + Vite con capa de servicios y contexto de autenticación. Preparado para producción con SQL Server, Nginx y servicio systemd, con guía de despliegue en DigitalOcean.','Plataforma web de venta y reserva de boletos de autobús para la empresa Aerorutas.','personal','web',ARRAY['Python','Django','Django REST Framework','React','JavaScript','SQL Server','Nginx'],ARRAY['JWT','Google OAuth','Vite','DigitalOcean'],'','',false,false,ARRAY['BenjiVZ/VA-Bus'],'',1);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Autobus - Gestión de flota, rutas y pagos','Sistema de gestión de autobuses con registro de flota y operadores, rutas trazadas en Google Maps y descritas por escrito, paradas georreferenciadas, sectores y tarifas por ruta o por tramo origen-destino. Incluye billetera con pago automático y una capa de pagos desacoplada, con proveedor abstracto listo para conectar la integración bancaria. Backend en Django 5.2 + DRF con documentación OpenAPI y app móvil en Flutter con login, rutas, mapa, tarifas y pago. La cercanía entre paradas se calcula con Haversine sin depender de PostGIS.','Backend Django y app Flutter para operadores de transporte: flota, rutas en mapa, tarifas y billetera.','personal','app',ARRAY['Python','Django','Django REST Framework','Flutter','Dart','Google Maps'],ARRAY['OpenAPI','SQLite'],'','',false,false,ARRAY['BenjiVZ/autobus'],'',2);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Damasco IA - Asistente Gemini conectado a SAP Business One','Asistente virtual desarrollado en Django que integra Google Gemini (API Key o Vertex AI) con el Service Layer de SAP Business One. Interpreta peticiones en lenguaje natural, construye la consulta OData adecuada mediante function calling y responde con artículos, socios de negocio, pedidos, facturas, almacenes o listas de precios. Guarda el historial de conversaciones, expone endpoints REST y cuenta con panel de administración y guías de configuración.','Chat con Gemini que consulta SAP Business One en lenguaje natural.','work','backend',ARRAY['Python','Django','Gemini','SAP'],ARRAY['Vertex AI','OData','REST'],'','',false,false,ARRAY['benjaS357/ia','BenjiVZ/ia-1'],'',3);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Damasco Monitor - Tasas de cambio','Sistema Django que consulta periódicamente las tasas de USD y EUR (DolarVzla) y el mercado P2P de Binance (USDT/VES) en horarios programados, guarda solo las variaciones y mantiene el historial completo. Incluye dashboard web con gráficas comparativas en tiempo real, filtros de consulta, panel de administración, comandos de gestión para correr los monitores y guía para ejecutarlo como servicio de Windows.','Monitor automático de USD, EUR y Binance P2P con dashboard de gráficas.','work','web',ARRAY['Python','Django','Chart.js','Binance API'],ARRAY['Servicios de Windows','SQLite'],'','',false,false,ARRAY['BenjiVZ/Damasco-Monitor'],'',4);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('ADD - Sistema de Distribución y Normalización','Herramienta interna que recibe archivos Excel de planificación y de salidas de mercancía, los normaliza contra maestros de centros de distribución (CEDIS), sucursales, regiones y gerentes regionales, y detecta productos faltantes, incidencias de PVP y errores de origen para resolverlos desde la web. Incluye biblioteca de maestros, mapeo por ID, tablero normalizado y decenas de scripts de análisis, verificación y corrección de datos, con documentación del proceso. Existe una versión inicial (ADD) y la versión ampliada con biblioteca de maestros y corrección de CEDIS (ADBD).','Sistema Django para cargar, normalizar y auditar planificaciones de distribución entre CEDIS y sucursales.','work','web',ARRAY['Python','Django','Pandas','Excel'],ARRAY['openpyxl','SQLite'],'','',false,false,ARRAY['benjaS357/ADD','BenjiVZ/ADBD','BenjiVZ/ADD'],'',5);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Frontend BVC - Panel de la Bolsa de Valores de Caracas','Interfaz web para seguir el mercado de la Bolsa de Valores de Caracas: cinta de cotizaciones, tarjetas de resumen, tabla de acciones con mini gráficas, histórico por símbolo de los últimos 30 días, evolución del dólar, cuadrícula de predicciones y analítica de récords. Consume una API propia mediante hooks reutilizables, soporta tema claro y oscuro y se despliega en Vercel.','Dashboard bursátil en React con cotizaciones, gráficas, dólar y predicciones.','personal','web',ARRAY['React','JavaScript','Vite','Chart.js'],ARRAY['Vercel','REST'],'','',false,false,ARRAY['BenjiVZ/frontend-BVC'],'',6);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Ivoo Ventas (RV) - App de apoyo comercial','Aplicación móvil para el equipo de ventas de Ivoo. Permite registrar las facturas del día desde un formulario, generar el reporte diario y consultar el historial, administrar la cartera de clientes y solicitar acceso o registrarse como usuario. Incluye herramientas de apoyo: conversor de moneda, calculadora de descuentos y calculadora de cuotas Cashea. Construida con Flutter y Provider, con servicios de autenticación y base de datos.','App Flutter para el equipo de ventas: facturas, clientes, reporte diario y herramientas de cálculo.','personal','app',ARRAY['Flutter','Dart','Provider'],ARRAY['SQLite','Material Design'],'','',false,false,ARRAY['BenjiVZ/RV'],'',7);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('SINPEL - Gestión técnica e inventario','Plataforma web para SINPEL, servicio técnico de línea blanca y marrón. Registra el ingreso de equipos con datos del cliente, factura, serial, fallas, accesorios y condición; sigue el envío y la recepción con el centro de servicio y controla el inventario de repuestos con importación masiva. Módulos de ingresos, inventario y reportes con panel de administración.','Sistema Django para casos de garantía, servicio técnico e inventario de repuestos.','work','web',ARRAY['Python','Django','JavaScript','HTML','CSS'],ARRAY['SQLite'],'','',false,false,ARRAY['benjaS357/sistema-sinpel'],'',8);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('MenuWeb - Menú digital para restaurantes','Sistema de menú digital para restaurantes. Desde el panel de Django se gestionan categorías (normal, especial, bebidas, postres), platillos con precio, disponibilidad y destacado, ingredientes con imagen, información del local y diseños de fondo. Genera códigos QR para que los clientes abran el menú desde la mesa; el frontend usa HTML, CSS y JavaScript con Tailwind vía PostCSS.','Menú web con código QR administrado desde Django: categorías, platillos, ingredientes y diseños.','personal','web',ARRAY['Python','Django','HTML','CSS','JavaScript','Tailwind'],ARRAY['Códigos QR','PostCSS'],'','',false,false,ARRAY['BenjiVZ/MenuWeb'],'',9);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Lidotel - Fidelización de agencias de viaje','Plataforma de fidelización para un hotel: cada agencia de viajes tiene su cuenta y acumula puntos por las reservas que genera, según tipo de habitación, duración de la estadía y servicios adicionales (transporte, tours, spa), con multiplicadores por temporada alta o último minuto y bonos por volumen de huéspedes. Gestiona reservas con estados (pendiente, confirmada, cancelada, completada), configuración de puntos desde el admin y gráficas con Chart.js sobre Jazzmin. Hay una copia del sistema en el repositorio django-nico.','Sistema Django de puntos para las agencias que reservan en un hotel.','personal','web',ARRAY['Python','Django','Chart.js','CSS'],ARRAY['Jazzmin','SQLite'],'','',false,false,ARRAY['BenjiVZ/django-lidotel','BenjiVZ/django-nico'],'',10);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Quigua - Inventario y listas de compra','Aplicación web para el control de inventario de un establecimiento: productos por categoría con unidad, cantidad y stock mínimo, alerta automática de reposición, historial de actualización y listas de compra con ítems, notas y cierre. Panel de administración personalizado (admin_interface, CKEditor, StreamField) y comandos de gestión para la carga de datos.','Sistema web Django para controlar el stock por categorías y generar listas de compra.','personal','web',ARRAY['Python','Django','JavaScript','CSS'],ARRAY['CKEditor','SQLite'],'','',false,false,ARRAY['BenjiVZ/Quigua'],'',11);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('App de Stock y Compras para posadas','Aplicación móvil multiplataforma para gestionar el inventario de una posada: categorías, productos con detalle y formulario, registro de uso o consumo de cada producto y lista de compras generada a partir del stock. Incluye tutorial integrado y arquitectura por funcionalidades con Provider. Evoluciona una primera versión (posada_app) con las mismas bases.','App Flutter para el inventario, el consumo de productos y las listas de compra de una posada.','personal','app',ARRAY['Flutter','Dart','Provider'],ARRAY['Material Design'],'','',false,false,ARRAY['BenjiVZ/Aplicacion-de-stok-y-compra','BenjiVZ/posada_app'],'',12);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Asistente Virtual Turístico de Mérida','Asistente conversacional para turistas de Mérida (Venezuela). El bot en Rasa entiende intenciones como buscar restaurantes, lugares para visitar, actividades al aire libre, museos, compras o vida nocturna, y responde con listados con tipo, dirección y horario. Los datos viven en una API con Django REST Framework (modelos, serializadores y carga inicial) que el bot consulta mediante acciones personalizadas. Publicado en dos repositorios (Turismo-AI y T-BIiAI) con el mismo contenido.','Chatbot Rasa con API Django que recomienda restaurantes, lugares y actividades en Mérida.','personal','backend',ARRAY['Python','Rasa','Django','Django REST Framework'],ARRAY['NLU','SQLite'],'','',false,false,ARRAY['BenjiVZ/Turismo-AI','BenjiVZ/T-BIiAI'],'',13);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('AI Asesor en Compras - E-commerce con asistente Rasa','E-commerce en Django (catálogo, carrito y usuarios) acompañado de un asistente Rasa que atiende al comprador: consulta productos y marcas, filtra por nombre, descripción y rango de precios mediante un formulario conversacional y adapta sus respuestas al estado de ánimo del usuario. Incluye un filtro de productos con NLTK y se desarrolló en Google IDX.','Tienda Django con un bot que busca productos, marcas y filtra por precio en conversación.','personal','web',ARRAY['Python','Django','Rasa','HTML','CSS','JavaScript'],ARRAY['NLTK','Google IDX'],'','',false,false,ARRAY['BenjiVZ/AI-asesor_en_compras'],'',14);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Bot Financiero - Asistente de finanzas personales','Asistente conversacional de finanzas personales. En Rasa se definen intenciones para consultar saldo y estado de cuenta, ver el historial de transacciones y registrar gastos mediante un formulario (monto y categoría), con avisos cuando se supera el 80 % del presupuesto mensual. Un proyecto Django persiste los datos y sirve la interfaz; un script levanta ambos servicios a la vez.','Chatbot Rasa con backend Django para consultar saldo, registrar gastos y ver el historial.','personal','backend',ARRAY['Python','Rasa','Django'],ARRAY['SQLite'],'','',false,false,ARRAY['BenjiVZ/BOT_FINANCIERO'],'',15);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Django Launcher - Lanzador de escritorio para proyectos Django','Utilidad de escritorio en Electron que pide la URL de un repositorio de GitHub, lo clona en una carpeta segura, detecta manage.py, ejecuta el servidor Django y muestra el sistema dentro de la misma ventana. Guarda la configuración de forma persistente, muestra una pantalla de carga en arranques posteriores y detiene el proceso al cerrar. Pensada para entregar sistemas Django a usuarios sin conocimientos técnicos.','App Electron que clona un repositorio de GitHub y ejecuta su servidor Django en una ventana.','personal','app',ARRAY['Electron','JavaScript','Node.js','Python'],ARRAY['simple-git'],'','',false,false,ARRAY['BenjiVZ/Django-Launcher'],'',16);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('SEAC - Control horario de locales comerciales','Aplicación web en Flask desarrollada durante la pasantía en A.S 28 La Candelaria. Recibe los reportes de control horario de los locales (Candelaria Center y Sambil), ejecuta macros VBA sobre el Excel, limpia y tabula los datos por día con Pandas, calcula aperturas, cierres y excepciones, y muestra resultados y diagnósticos con gráficas Plotly. Exporta a CSV y XLSX y guarda en MySQL.','Herramienta Flask que procesa los Excel de apertura y cierre de tiendas en centros comerciales.','internship','web',ARRAY['Python','Flask','Pandas','Excel','MySQL'],ARRAY['VBA','Plotly','openpyxl'],'','',false,false,ARRAY['BenjiVZ/SEAC'],'',17);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Implementación de OCS Inventory','Implementación del servidor OCS Inventory NG 2.11 durante la pasantía en A.S 28 La Candelaria (Constructora - Sambil) para inventariar equipos y activos de TI. El repositorio conserva la configuración del servidor (Apache, API y reportes), el respaldo de la base de datos y los comandos de arranque documentados.','Despliegue y configuración de OCS Inventory NG para el control de activos de TI.','internship','sistemas',ARRAY['OCS Inventory','Linux','Apache','MySQL','Perl'],ARRAY['PHP'],'','',false,false,ARRAY['BenjiVZ/OCSInventory'],'',18);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Implementación de osTicket','Instalación y personalización de osTicket como mesa de ayuda para las solicitudes de TI en A.S 28 La Candelaria (Constructora - Sambil). Incluye la instancia configurada (osTicket-sambil) y el respaldo de la base de datos de pruebas.','Mesa de ayuda con osTicket para la gestión de solicitudes de TI en Sambil.','internship','sistemas',ARRAY['osTicket','PHP','MySQL'],ARRAY['Apache'],'','',false,false,ARRAY['BenjiVZ/osticket'],'',19);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('E-commerce con Django','Plataforma de comercio electrónico en Django organizada en apps: catálogo de productos con imágenes, carrito de compras, usuarios con formularios propios y un módulo de administración con admin-interface. Plantillas y estilos propios por cada app.','Tienda en línea con catálogo, carrito, usuarios y panel de administración.','personal','web',ARRAY['Python','Django','HTML','CSS'],ARRAY['SQLite'],'','',false,false,ARRAY['BenjiVZ/Benja_projectoDjango'],'',20);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('E-commerce en Google IDX con filtro inteligente','Evolución del e-commerce en Django construida en el entorno Google IDX (Nix): apps de catálogo, carrito y usuarios con señales, decoradores y estilos SCSS. Incorpora un bot de filtrado de productos que procesa la consulta del usuario con NLTK (tokenización, lematización y stopwords en español) y la traduce en búsquedas sobre la base de datos. Publicado como djangoapp (base) y djangoapp-main (versión completa con el bot).','Tienda Django desarrollada en Google IDX con un bot de filtrado de productos por lenguaje natural.','personal','web',ARRAY['Python','Django','NLTK','SCSS'],ARRAY['Google IDX','Nix'],'','',false,false,ARRAY['BenjiVZ/djangoapp-main','BenjiVZ/djangoapp'],'',21);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Lumi Booth - Cabina de fotos web','Aplicación web en React + Vite que convierte la cámara del dispositivo en una cabina de fotos: toma la secuencia de fotos, aplica filtros, permite elegir plantilla (tira o cuadrícula), tema, sticker y leyenda con fecha, y descarga el resultado en PNG o PDF. Todo se procesa en el navegador; las fotos nunca salen del equipo. El repositorio vive en las dos cuentas de GitHub.','Cabina de fotos en el navegador: filtros, plantillas, stickers y descarga en PNG o PDF.','work','web',ARRAY['React','JavaScript','Vite','CSS'],ARRAY['Canvas','PDF'],'','',false,false,ARRAY['benjaS357/lumi-booth','BenjiVZ/lumi-booth'],'',22);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('El cielo que nos vio - Mapa estelar de una fecha','Página de una sola pieza que recuerda un momento mostrando el cielo real que había sobre Valencia, Carabobo, esa noche: el disco estelar se dibuja solo (estrellas, constelaciones trazándose una a una, puntos cardinales) y se puede explorar; incluye contadores en vivo y un fondo con capas de estrellas en parallax y estrellas fugaces. Hecha con React + Vite a partir de un catálogo de estrellas y desplegada como sitio estático.','Página-regalo en React que dibuja el cielo real de un lugar y un instante concretos.','personal','web',ARRAY['React','JavaScript','Vite','CSS'],ARRAY['Canvas','Vercel'],'','',false,false,ARRAY['benjaS357/nuestra-noche'],'',23);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Un date especial - Página interactiva','Página interactiva en Next.js desplegada en Vercel: mural de flores que se abre al tocar, botón que huye del mouse, planificador de cita en tres pasos que genera un mensaje para copiar, página secreta protegida por clave y cierre con confeti y lluvia de corazones. Conserva la versión original en HTML, CSS y JavaScript puro.','Página romántica en Next.js con fases interactivas, clave secreta y confeti.','personal','web',ARRAY['Next.js','React','JavaScript','CSS'],ARRAY['Vercel'],'','',false,false,ARRAY['benjaS357/currucumor'],'',24);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Calculadora de Traslación y Rotación 2D/3D','Proyecto universitario en Jupyter / Google Colab que aplica traslaciones y rotaciones a figuras en dos y tres dimensiones mediante matrices de transformación, mostrando paso a paso los cálculos y la figura resultante con Matplotlib.','Notebook de Google Colab para calcular y graficar transformaciones geométricas.','university','backend',ARRAY['Python','Jupyter','NumPy','Matplotlib'],ARRAY['Google Colab'],'','',false,false,ARRAY['BenjiVZ/Calculadora-de-Traslaci-n-y-Rotaci-n-2D3D'],'',25);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Calculadora con Tkinter','Aplicación de escritorio en Python con interfaz Tkinter que realiza operaciones aritméticas básicas y conversiones entre unidades de longitud (metros, centímetros, milímetros, pies, yardas, millas) y de capacidad (litros, mililitros, galones, cuartos, pintas, onzas).','Calculadora de escritorio con conversión de unidades de longitud y capacidad.','university','app',ARRAY['Python','Tkinter'],'{}','','',false,false,ARRAY['BenjiVZ/Calculadora-tkinter'],'',26);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Duck''s Dodge - Videojuego con Pygame','Videojuego arcade desarrollado con Pygame: el jugador guía a un pato que debe esquivar objetos que caen del cielo, con velocidad y cantidad crecientes, sistema de puntuación, reinicio rápido y estética retro.','Juego arcade en Python: esquiva los objetos que caen y supera tu récord.','university','app',ARRAY['Python','Pygame'],'{}','','',false,false,ARRAY['BenjiVZ/Videojuego-pygame'],'',27);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Mega Cars Wash - Sitio web de autolavado','Página web para el autolavado Mega Cars Wash desarrollada en tres versiones independientes: JavaScript con Firebase (autenticación con Google y Facebook, publicaciones y mensajes), PHP con MySQL y una versión inicial en HTML, CSS y JavaScript. Proyecto de formación temprana en desarrollo web. Repositorios: Mega-Cars-Wash, MCW, MCW-con-JavaScrip y MCW-con-PHP.','Sitio para un autolavado con registro e inicio de sesión, en tres implementaciones.','university','web',ARRAY['HTML','CSS','JavaScript','Firebase','PHP','MySQL'],'{}','','',false,false,ARRAY['BenjiVZ/Mega-Cars-Wash','BenjiVZ/MCW','BenjiVZ/MCW-con-JavaScrip','BenjiVZ/MCW-con-PHP'],'',28);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Sistema de Registro Académico','Sistema web de registro académico desarrollado con PHP y MySQL: alta de estudiantes y profesores, carga de notas y consultas, con interfaz en HTML y CSS y respaldo de la base de datos. Uno de los primeros proyectos de formación.','Registro de estudiantes, profesores y notas con PHP y MySQL.','university','web',ARRAY['PHP','MySQL','HTML','CSS'],'{}','','',false,false,ARRAY['BenjiVZ/Pagina-Registro'],'',29);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Página Web de Videojuegos','Página web estática sobre videojuegos con varias secciones, galería de imágenes y algo de JavaScript, realizada como práctica de maquetación con HTML y CSS.','Sitio informativo sobre videojuegos maquetado con HTML y CSS.','university','web',ARRAY['HTML','CSS','JavaScript'],'{}','','',false,false,ARRAY['BenjiVZ/Pagina-WEB-de-Videojuegos'],'',30);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Chatbot base con Rasa','Proyecto base de chatbot con Rasa 3: datos de entrenamiento (NLU), reglas e historias, dominio con respuestas, acciones personalizadas en Python y una página HTML mínima para conversar con el bot desde el navegador. Incluye modelos entrenados y los comandos para levantar el servidor con la API habilitada. Sirvió de punto de partida para los asistentes de e-commerce, turismo y finanzas.','Asistente conversacional en Rasa con intenciones, reglas, historias y acciones personalizadas.','personal','backend',ARRAY['Python','Rasa','HTML'],ARRAY['NLU'],'','',false,false,ARRAY['BenjiVZ/Rasa'],'',31);
insert into projects (title,description,short_description,category,subcategory,tech_stack,sub_skills,live_url,repo_url,featured,hidden,github_repos,image_url,sort_order) values ('Portafolio MastersLogic - Este sitio','Sitio personal construido con Vue 3 y Vite: tema claro y oscuro, sección de proyectos con filtros y paginación, experiencia, servicios, flyers y contacto por WhatsApp. Los contenidos viven en Supabase y, si la base no responde, el sitio cae a un respaldo local en JSON sin mezclar fuentes. Incluye un panel /admin protegido con edición en línea, filtros, ocultar proyectos, guardado masivo, sugerencias de importación y una página de respaldo completo descargable. Desplegado en Vercel.','Portafolio en Vue 3 con panel de administración, Supabase y respaldo local sin conexión.','personal','web',ARRAY['Vue.js','JavaScript','Vite','Supabase','CSS'],ARRAY['Vercel','vue-router'],'','',false,false,ARRAY['benjaS357/Portafolio-Benja','BenjiVZ/Portafolio-Benja'],'',32);
