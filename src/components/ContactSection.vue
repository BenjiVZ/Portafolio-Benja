      ...
      <div class="contact-grid">
        <div class="contact-info">
          ...
          <div class="contact-methods">
            ...
            <a :href="waLink()" target="_blank" rel="noopener" class="contact-method">
              <div class="method-icon">
              ...
              <div class="method-text">
                ...
                <span class="method-value">Escríbeme directo</span>
              </div>
            </a>
          </div>
          ...
          <div class="contact-socials">
            ...
            <a :href="waLink()" target="_blank" rel="noopener" class="social-link whatsapp-link" aria-label="WhatsApp">
...
import { waLink, usuarioGithub } from '../lib/site'
...
/* El margen por defecto del header (4rem) dejaba un hueco enorme
   entre el titulo y el subtitulo: aqui el subtitulo va dentro. */
...
.contact-subtitle {
  ...
  max-width: 460px;
  /* El titulo lleva un subrayado en ::after (bottom: -8px) */
...
/* min-width: 0 deja que el email largo se ajuste en vez de desbordar */
.method-text {
  min-width: 0;
}
...
/* Las dos cuentas de GitHub comparten icono: se separan por el nombre,
   asi que estas van en pastilla con texto y el resto queda en circulo. */
.social-github {
  width: auto;
  gap: 8px;
  padding: 0 14px;
